export const english = {
    ...
    projectsSubTitle: '10 production-ready projects, all live on Vercel and open-sourced on GitHub',
    projects: [
        ...
        { img: 'image-project-furniture',    alt: 'photo project furniture',    title: 'Furniture Ordering App', color: "#6366F1", link: 'https://website-for-ordering-furniture.vercel.app/',   linkText: 'Live Demo', github: 'https://github.com/Ashot-Harutyunyan/Website-for-ordering-furniture', githubText: 'Code', ArrayTechnologies: ['FaReact', 'SiReactrouter', 'SiReactquery', 'FaSass', 'SiFirebase', 'DiReact', 'BsGithub', 'IoLogoVercel'],                                   description: 'Ordering Furniture is a modern, responsive, multi-page website for a furniture company. The project includes a product catalog, "About Us" and "Contact Us" pages, a product detail page, and support for three languages (Armenian, Russian, and English). The interface features a dark and light color palette with easy navigation and catalog filtering.' },
    ],
    skillsTitle: 'SKILLS',
...
export const russia = {
    ...
    projectsSubTitle: '10 готовых к внедрению проектов, все размещены на Vercel и имеют открытый исходный код на GitHub',
    projects: [
        ...
        { img: 'image-project-furniture',    alt: 'photo project furniture',    title: 'Приложение Для Заказа Мебели', color: "#6366F1", link: 'https://website-for-ordering-furniture.vercel.app/',   linkText: 'Живая Демонстрация', github: 'https://github.com/Ashot-Harutyunyan/Website-for-ordering-furniture', githubText: 'Код', ArrayTechnologies: ['FaReact', 'SiReactrouter', 'SiReactquery', 'FaSass', 'SiFirebase', 'DiReact', 'BsGithub', 'IoLogoVercel'],                                   description: 'Ordering Furniture — современный адаптивный многостраничный сайт для мебельной компании. Проект включает каталог продукции, страницы «О нас» и «Контакты», страницу с подробной информацией о товаре и поддержку трёх языков (армянского, русского и английского). Интерфейс выполнен в тёмной и светлой цветовой палитре с удобной навигацией и фильтрацией каталога.' },
    ],
    skillsTitle: 'НАВЫКИ',
...
export const armenian = {
    ...
    projectsSubTitle: '10 իրականացման պատրաստ նախագծեր, բոլորը տեղակայված են Vercel-ում և բաց կոդով՝ GitHub-ում',
    projects: [
        ...
        { img: 'image-project-furniture',    alt: 'photo project furniture',        title: 'Կահույքի պատվերի հավելված', color: "#6366F1", link: 'https://website-for-ordering-furniture.vercel.app/',   linkText: 'Կենդանի Ցուցադրություն', github: 'https://github.com/Ashot-Harutyunyan/Website-for-ordering-furniture', githubText: 'Կոդ', ArrayTechnologies: ['FaReact', 'SiReactrouter', 'SiReactquery', 'FaSass', 'SiFirebase', 'DiReact', 'BsGithub', 'IoLogoVercel'],                                   description: 'Ordering Furniture-ը ժամանակակից, հարմարվող բազմաէջ կայք է կահույքի արտադրությամբ և վերականգնմամբ զբաղվող ընկերության համար։ Նախագիծը ներառում է ապրանքների կատալոգ, «Մեր մասին» և «Կապ» էջեր, ապրանքի մանրամասն էջ և երեք լեզուների աջակցություն (հայերեն, ռուսերեն և անգլերեն)։ Կայքի ինտերֆեյսը մշակված է մուգ և բաց գունային ոճով՝ հարմար նավիգացիայով և կատալոգի ֆիլտրումով։' },
    ],
